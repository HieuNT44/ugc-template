...
const LABELS = {
  en: {
    ...
    emptyDescription: "Add your first entry to showcase on your profile.",
    ...
    experiences: {
      ...
      description:
        "Add roles, companies, and timelines. Shown on your public profile.",
      company: "Company",
      ...
      titlePh: "e.g. Senior Engineer",
      locationPh: "e.g. Tokyo, Japan",
      descriptionPh: "Brief summary of your role and impact",
    },
    educations: {
      title: "Education",
      ...
      endDate: "End date",
      descriptionField: "Description",
      schoolPh: "e.g. University of Tokyo",
      degreePh: "e.g. Bachelor of Science",
      fieldPh: "e.g. Computer Science",
      descriptionPh: "Honors, activities, or highlights",
    },
    certifications: {
      title: "Certifications",
      description: "Professional credentials with optional certificate image.",
      ...
      uploadImage: "Upload certificate",
      replaceImage: "Replace image",
      removeImage: "Remove image",
      namePh: "e.g. AWS Solutions Architect",
      organizationPh: "e.g. Amazon Web Services",
      credentialIdPh: "Optional ID or license number",
